...
// Handler evaluates one of the checks of a policy.
type Handler struct {
	log            hclog.Logger
	strategyRunner strategy.Runner
	metricsGetter  apm.Looker
...
func NewHandler(config *Config, c *sdk.ScalingPolicyCheck) *Handler {
	return &Handler{
...
func (ch *Handler) GetNewCountFromMetrics(ctx context.Context, currentCount int64, metrics sdk.TimestampedMetrics) (sdk.ScalingAction, error) {
...
// start begins the execution of the check handler.
func (ch *Handler) runStrategy(ctx context.Context, currentCount int64, metrics sdk.TimestampedMetrics) (sdk.ScalingAction, error) {
...
func (ch *Handler) runStrategyRun(count int64, checkEval *sdk.ScalingCheckEvaluation) (*sdk.ScalingCheckEvaluation, error) {
...
func (ch *Handler) runAPMQuery(ctx context.Context) (sdk.TimestampedMetrics, error) {
