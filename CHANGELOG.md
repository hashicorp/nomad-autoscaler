 ...
 * plugins/strategy: the `threshold` strategy allows for different scaling actions based on a set of tiers defined by upper and lower bound metric values [[GH-438]](https://github.com/hashicorp/nomad-autoscaler/issues/438)
