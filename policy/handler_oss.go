...
func (nv *noopVerticalCheckRunner) runCheckAndCapCount(_ context.Context, currentCount int64, _ *queryMetricsCache) (action sdk.ScalingAction, participating bool, err error) {
